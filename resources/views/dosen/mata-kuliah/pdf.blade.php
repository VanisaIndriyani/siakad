...
<body>
    @php
        ...
        $dosenNomor = $pickNomor($dosen ?? null);
    @endphp
    ...
    <div class="doc-title">DAFTAR MATA KULIAH DOSEN</div>
        ...
        <tr>
            <td style="width: 50%; vertical-align: top;">
                <table class="kv2">
                    ...
                    <tr>
                        <td class="label">NUPTK / NIDN</td>
                        <td class="colon">:</td>
                        <td class="value">{{ $dosenNomor ?? '-' }}</td>
                    </tr>
                </table>
            </td>
    ...
    <table class="tbl">
        <thead>
            <tr>
                ...
                <th style="width: 70px;" class="center">Semester</th>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="8" class="center">Belum ada data mata kuliah.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="sign-wrap">
        <div class="sign-box">
            ...
            <div class="sign-name">{{ $dosen->nama ?? '-' }}</div>
            @if($dosenNomor)
                <div style="font-size: 9px; margin-top: 2px;">NUPTK. {{ $dosenNomor }}</div>
            @endif
        </div>
    </div>
</body>
