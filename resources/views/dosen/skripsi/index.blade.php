            ...
            <tbody class="divide-y divide-white/10">
                @forelse ($items as $i => $row)
                    ...
                    <tr class="hover:bg-white/5">
                        ...
                        <td class="px-4 py-3 text-emerald-100/85 max-w-sm">{{ $row->judul ?: '-' }}</td>
                        <td class="px-4 py-3">
                            @if ($row->nomor_sk)
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-end gap-2 flex-wrap">
                                <a href="{{ route('dosen.skripsi.bimbingan.show', $row) }}" class="h-9 px-3 inline-flex items-center gap-2 rounded-xl bg-emerald-500/15 hover:bg-emerald-500/25 border border-emerald-500/20 transition text-xs font-medium">
                                ...
                                @if ($row->sk_pembimbing_path)
                                    <a href="{{ route('dosen.skripsi-pengajuan.sk.preview', $row) }}" target="_blank"
                                    ...
                                    <a href="{{ route('dosen.skripsi-pengajuan.sk.download', $row) }}"
