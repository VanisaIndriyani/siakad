...
<html>
    ...
    <body>
        <div class="header">
            ...
            <div class="meta">
                <div class="meta-row"><span class="muted">Mahasiswa:</span> {{ $ppl->mahasiswa?->nama_lengkap ?: '-' }} ({{ $ppl->mahasiswa?->npm ?: '-' }})</div>
                <div class="meta-row"><span class="muted">Instansi/Sekolah:</span> {{ $ppl->instansi_nama }}</div>
                <div class="meta-row"><span class="muted">Pembimbing:</span> {{ $ppl->dosenPembimbing?->nama ?: '-' }}@if ($ppl->dosenPembimbing2?->nama), {{ $ppl->dosenPembimbing2?->nama }}@endif</div>
        ...
        <div class="card">
            <table>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" style="text-align: center; padding: 16px; color: #64748b;">Belum ada pesan bimbingan.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
