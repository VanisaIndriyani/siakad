...
<head>
    ...
    <title>Daftar Pengajuan PPL</title>
    <style>
        @page { margin: 14mm; }
...
<body>
    ...
    <div class="doc-title">DAFTAR PENGAJUAN PRAKTIK PENGALAMAN LAPANGAN (PPL)</div>
    <div class="doc-sub">
        ...
        @forelse ($items as $row)
            <tr>
                ...
                <td>
                    ...
                    <div style="font-size: 9px; color: #374151;">Prodi: {{ $row->mahasiswa?->program_studi ?: '-' }}</div>
                </td>
                <td>
                    <div style="font-weight: 700;">{{ $row->instansi_nama ?: '-' }}</div>
                    @if($row->instansi_alamat)
                        <div style="font-size: 9px; color: #374151;">{{ $row->instansi_alamat }}</div>
                    @endif
                </td>
                <td class="center">
                ...
                <td>
                    ...
                    @if($row->dosenPembimbing2?->nama)
                        <div style="font-size: 9px; color: #374151;">II: {{ $row->dosenPembimbing2?->nama }}</div>
                    @endif
                </td>
            </tr>
        @empty
            <tr>
                <td colspan="5" class="center" style="padding: 16px;">Belum ada data pengajuan PPL.</td>
            </tr>
        @endforelse
        </tbody>
    </table>
