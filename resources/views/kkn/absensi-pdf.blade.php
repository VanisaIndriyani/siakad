...
<body>
    @php
        ...
        $pembimbingStr = '';
        if ($kkn->posko?->pembimbingS && $kkn->posko->pembimbingS->count() > 0) {
            $pembimbingStr = $kkn->posko->pembimbingS->pluck('nama')->filter()->implode(' • ');
        }
    ...
    <div class="doc-title">DAFTAR HADIR KULIAH KERJA NYATA (KKN)</div>
    <div class="doc-sub">
    ...
    <div class="info-box">
        <div class="info-row">
            ...
            @endif
            <div><span>Dosen Pembimbing (DPL)</span><span>: {{ $pembimbingStr ?: '-' }}</span></div>
        </div>
        <div class="summary-row">
            <span>Jumlah Hari: <b>{{ $absensis->count() }}</b></span>
