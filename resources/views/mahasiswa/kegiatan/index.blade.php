<x-portal-layout :title="'Kegiatan - '.config('app.name')" subtitle="Daftar Kegiatan & Seminar">
    ...
    @php
        ...
        $namaPanggil = $mahasiswa->nama ?? auth()->user()->name ?? 'Teman';
        ...
        if ($inisial === '') $inisial = 'M';
    @endphp

    {{-- CRITICAL FALLBACK CSS — jika Tailwind build delay, tampilan TETAP BAGUS.
         Inject langsung inline agar berjalan tanpa tergantung external CSS --}}
    <style>
    /* Hero banner gradient emerald-teal + shadow premium */
    .mhs-hero {
    ...
    <script>
        // Pastikan halaman SELALU scroll ke PALING ATAS saat load.
        // User sering melihat tampilan "setengah" karena ke skip bagian hero.
        if ('scrollTo' in window) {
            try { window.scrollTo({ top: 0, left: 0, behavior: 'instant' in window ? 'auto' : 'auto' }); } catch(e){}
        }
    ...
    {{-- ===============================================
         HERO BANNER + WELCOME + 3 STATISTIC CARDS
        =============================================== --}}
    <section class="mhs-hero">
        ...
        <div class="mhs-hero-top">
            <div class="mhs-head">
                <div class="mhs-avatar-wrap">
                    @if(!empty($mahasiswa->foto) || !empty(optional(auth()->user())->foto))
                        <img
                            src="{{ \Illuminate\Support\Facades\Storage::url($mahasiswa->foto ?? auth()->user()->foto) }}"
                ...
                <div>
                    ...
                    <p class="mhs-sub">
                        Yuk ikuti kegiatan &amp; seminar kampus! Setiap kehadiran kamu akan tercatat otomatis dan
            ...
            <div class="mhs-cta-row">
                <a href="{{ route('mahasiswa.kegiatan.sertifikat-saya') }}" class="btn-sertif">
        ...
        <div class="stat-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-label">Kegiatan yang Kamu Ikuti</div>
            </div>
            <div class="stat-card">
                <div class="stat-head">
    ...
    {{-- ===============================================
         FILTER / TOOLBAR
        =============================================== --}}
    <form method="GET" action="{{ route('mahasiswa.kegiatan.index') }}" class="filter-wrap">
        <div class="filter-head">
            <div class="filter-head-left">
                ...
                <div>
                    ...
                    <div class="filter-head-sub">Temukan kegiatan yang cocok dengan minatmu di bawah ini.</div>
                </div>
            </div>
        ...
        <div class="filter-grid">
            ...
            <div class="f-3">
                <div class="f-btnrow">
                    ...
                    <a href="{{ route('mahasiswa.kegiatan.index') }}" class="f-reset" title="Reset filter">
    ...
    {{-- ===============================================
         DAFTAR KEGIATAN (EMPTY / CARD GRID)
        =============================================== --}}
    <section id="daftar-kegiatan">
        @if($items->isEmpty())
            <div class="empty-wrap">
                ...
                <div class="empty-sub">
                    Belum ada kegiatan untuk ditampilkan saat ini. Silakan kembali lagi nanti ya, atau coba hapus filter pencarianmu.
                </div>
                <a href="{{ route('mahasiswa.kegiatan.index') }}" class="empty-btn">
                ...
                @foreach($items as $item)
                    ...
                    <article class="act-card">
                        ...
                        <div class="act-body">
                            ...
                            <div>
                                <div class="flow-head">
                                    <div class="flow-title">Status Kamu</div>
                            ...
                            <div class="cta-row">
                                ...
                                <a href="{{ route('mahasiswa.kegiatan.show', $item) }}" class="cta-btn
