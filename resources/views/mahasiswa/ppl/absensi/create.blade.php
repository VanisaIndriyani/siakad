<x-portal-layout :title="'Tambah Daftar Hadir PPL - '.config('app.name')" subtitle="PPL">
    <x-slot:sidebar>
    ...
    <form method="POST" action="{{ route('mahasiswa.ppl.absensi.store', $ppl) }}" class="mt-5 rounded-2xl bg-white/5 border border-white/10 p-5">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <textarea id="keterangan" name="keterangan" rows="3"
                    ...
                    placeholder="Contoh: Surat keterangan sakit dari dokter...">{{ old('keterangan') }}</textarea>
