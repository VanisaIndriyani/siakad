...
<head>
    ...
    <style>
        ...
        .tbl th, .tbl td { border: 1px solid #111827; padding: 4px 2px; text-align: center; vertical-align: middle; }
    ...
    <table class="tbl">
        <thead>
            <tr>
                ...
                <th rowspan="2" class="text-left" style="width: 400px;">Nama Mahasiswa</th>
                <th colspan="16">Pertemuan Ke-</th>
                <th rowspan="2" style="width: 45px;">Ket.</th>
            </tr>
            <tr>
                @for ($i = 1; $i <= 16; $i++)
                    <th style="width: 23px; font-size: 8px;">{{ $i }}</th>
                @endfor
            </tr>
        </thead>
        <tbody>
            @forelse ($mahasiswa as $i => $mhs)
                <tr>
                    <td>{{ $i + 1 }}</td>
                    <td style="font-size: 8px; font-weight: 700;">{{ $mhs->npm }}</td>
