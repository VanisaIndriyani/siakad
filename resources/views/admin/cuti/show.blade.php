    ...
    <div class="flex items-center justify-between gap-3 mb-5">
        ...
        <div class="flex items-center gap-2">
            @if ($cuti->status === 'approved')
                <a href="{{ route('admin.cuti.pdf', $cuti) }}" class="h-10 px-4 inline-flex items-center gap-2 rounded-xl bg-emerald-500/15 hover:bg-emerald-500/20 border border-emerald-500/20 transition text-emerald-100">
                    <i class="fa-solid fa-file-pdf"></i>
                    Cetak Surat Cuti
                </a>
            @endif
            <a href="{{ route('admin.cuti.index') }}" class="h-10 px-4 inline-flex items-center gap-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition text-white">
