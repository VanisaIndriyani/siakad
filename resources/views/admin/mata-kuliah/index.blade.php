<x-portal-layout :title="'Mata Kuliah - '.config('app.name')" subtitle="Manajemen Mata Kuliah">
    ...
    <div class="mt-8 mb-8">
        <a href="{{ route('admin.dokumen-kuliah.index') }}" class="group block relative rounded-2xl bg-gradient-to-br from-emerald-500/10 via-teal-500/10 to-cyan-500/10 border border-emerald-400/25 p-5 sm:p-6 hover:border-emerald-400/40 hover:shadow-[0_0_60px_-15px_rgba(16,185,129,0.45)] transition-all duration-300">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex items-start gap-4">
                    <div class="shrink-0 w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500/30 to-teal-500/30 border border-emerald-400/30 inline-flex items-center justify-center shadow-[0_0_30px_-5px_rgba(16,185,129,0.55)] group-hover:scale-105 transition-transform">
                        <i class="fa-solid fa-file-arrow-up text-emerald-200 text-xl"></i>
                    </div>
                    <div class="min-w-0">
                        <div class="text-lg sm:text-xl font-bold text-emerald-100 tracking-tight leading-snug">Upload SK Mengajar &amp; Roster Kuliah</div>
                        <div class="mt-1.5 text-sm text-emerald-100/70 leading-relaxed">
                            Upload 1x per prodi → otomatis tersedia untuk semua dosen di prodi tersebut.
                        </div>
                    </div>
                </div>
                <div class="flex items-center gap-2 shrink-0">
                    <div class="h-11 px-5 inline-flex items-center gap-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 active:bg-emerald-600 shadow-[0_0_25px_-5px_rgba(16,185,129,0.65)] group-hover:shadow-[0_0_32px_-2px_rgba(16,185,129,0.8)] transition text-sm font-bold text-white">
