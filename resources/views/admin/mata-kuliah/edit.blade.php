    ...
    <form method="POST" action="{{ route('admin.mata-kuliah.update', $mataKuliah) }}" class="rounded-2xl bg-white/5 border border-white/10 p-5">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="number" name="sks" value="{{ old('sks', $mataKuliah->sks) }}" class="mt-2 w-full h-11 rounded-xl bg-white/5 border border-white/10 focus:border-emerald-400 focus:ring-emerald-400" required />
