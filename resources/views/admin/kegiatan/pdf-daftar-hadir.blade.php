@php
    ...
    */
    $logoPaths = [
        ...
        base_path('public_html/img/lo.jpeg'),
        base_path('public_html/img/lo.jpg'),

        base_path('public/img/lo.jpeg'),
        base_path('public/img/lo.jpg'),
    ];
    ...
    if ($logoFinalSrc !== '') {
        ...
        if ($raw !== false) {
            $logoBase64 =
                'data:'.$mime.';base64,'.base64_encode($raw);
        }
    }
    ...
    */
    ...
    $penyelenggaraVal =
        trim((string)($kegiatan->penyelenggara ?? ''));

    if ($penyelenggaraVal === '') {
        $penyelenggaraVal = 'IAI DDI SIDRAP';
    }

    $ketuaPanitiaNama =
        trim((string)($kegiatan->ketua_panitia_nama ?? ''));

    $ketuaPanitiaNip =
        trim((string)($kegiatan->ketua_panitia_nip ?? ''));

    $rektorNama =
        trim((string)($kegiatan->rektor_nama ?? ''));

    $rektorNip =
        trim((string)($kegiatan->rektor_nip ?? ''));
...
<head>
    ...
    <style>
        ...
        */
        ...
        |
        | Logo tetap di kiri.
        | Teks kop dibuat absolute agar benar-benar center terhadap
        | seluruh halaman A4, bukan center terhadap sisa ruang setelah logo.
        |
        */
...
@foreach($chunks as $chunkIdx => $pagePeserta)
    ...
    @php
        ...
        |--------------------------------------------------------------------------
        |
        | Maksimal 15 agar tabel tetap rapi.
        |
        */
    ...
    <div
        class="page"
        style="page-break-after: {{ $isLast ? 'auto' : 'always' }};"
    >
        ...
        <div class="kop-wrap">
            ...
            <div class="kop-text">
                ...
                <div class="kop-akreditasi">
                    ...
                    &bull;
                    SK : 337/SK/BAN-PT/Ak-S/2.0/PT/VI/2026
                </div>

                <div class="kop-alamat">
                    Alamat : Jl. Tugu Tani Kel. Majelling Watang Sidenreng Rappang
                </div>

                <div class="kop-kontak">
                    E-mail : iaiddisidrap@gmail.com
                    &nbsp;&nbsp;
                    Website : www.yppddisrapp.ac.id
                </div>
            ...
            <div class="info-with-logo">
                ...
                <table class="info-table">
                    ...
                    <tr>
                        ...
                        <td class="kanan" style="font-weight:700;">
                            {{ strtoupper($kegiatan->judul ?? '-') }}
                        </td>


                        <td class="kiri" style="width:38mm;">
                            Tempat / Lokasi
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="kanan">
                            {{ strtoupper($kegiatan->jenis_kegiatan ?? '-') }}
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="kanan">
                            {{ formatTglIndo($kegiatan->tanggal_mulai ?? $kegiatan->tanggal ?? now()) }}
                        </td>
        ...
        <!-- =========================================================
             TANDA TANGAN + FOOTER (HALAMAN TERAKHIR SAJA)
        ========================================================== -->
            ...
            <table class="ttd-wrap-table">
                <tr>
                    <td class="ttd-col" style="width:50%;">
                        ...
                        <div class="ttd-nama">
                            {!! $ketuaPanitiaNama !== '' ? e(strtoupper($ketuaPanitiaNama)) : '_______________________________' !!}
                        </div>
                        <div class="ttd-nip">
                            {!! $ketuaPanitiaNip !== '' ? 'NIP. '.e($ketuaPanitiaNip) : 'NIP. _____________________' !!}
                        </div>
                    </td>
                    <td class="ttd-col" style="width:50%;">
                        <div class="ttd-label">
                            Sidrap, {{ $nowCetak->format('j') }} {{ bulanIndo($nowCetak->month) }} {{ $nowCetak->format('Y') }}
                        </div>
                        <div class="ttd-sub">Pimpinan / Penanggung Jawab</div>
                        <div class="ttd-space">&nbsp;</div>
                        <div class="ttd-garis">&nbsp;</div>
                        <div class="ttd-nama">
                            {!! $rektorNama !== '' ? e(strtoupper($rektorNama)) : '_______________________________' !!}
                        </div>
                        <div class="ttd-nip">
                            {!! $rektorNip !== '' ? 'NIP. '.e($rektorNip) : 'Rektor IAI DDI Sidrap' !!}
                        </div>
                    </td>
                </tr>
            </table>
