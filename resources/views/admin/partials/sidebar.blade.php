...
@if (in_array(auth()->user()->role, ['admin', 'akademik'], true))
    ...
    <a href="{{ route('admin.khs.index') }}"
       class="flex items-center gap-3 px-4 py-3 rounded-xl border transition {{ request()->routeIs('admin.khs.*') && !request()->routeIs('admin.rekap-nilai.*') ? 'bg-white/10 border-white/10' : 'border-transparent hover:bg-white/5 hover:border-white/10' }}">
        <i class="fa-solid fa-award text-emerald-300"></i>
        <span class="text-sm font-medium">KHS</span>
    </a>
    <a href="{{ route('admin.rekap-nilai.index') }}"
       class="flex items-center gap-3 px-4 py-3 rounded-xl border transition {{ request()->routeIs('admin.rekap-nilai.*') ? 'bg-white/10 border-white/10' : 'border-transparent hover:bg-white/5 hover:border-white/10' }}">
    ...
    <a href="{{ route('admin.nilai-monitoring.index') }}"
       class="flex items-center gap-3 px-4 py-3 rounded-xl border transition {{ request()->routeIs('admin.nilai-monitoring.*') ? 'bg-white/10 border-white/10' : 'border-transparent hover:bg-white/5 hover:border-white/10' }}">
        ...
        <span class="text-sm font-medium">Input Nilai Dosen</span>
    </a>
    ...
    <a href="{{ route('admin.informasi.index') }}"
       class="flex items-center gap-3 px-4 py-3 rounded-xl border transition {{ request()->routeIs('admin.informasi.*') ? 'bg-white/10 border-white/10' : 'border-transparent hover:bg-white/5 hover:border-white/10' }}">
