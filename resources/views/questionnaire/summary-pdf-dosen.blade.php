...
<head>
    ...
    <title>Rekap Kuesioner Dosen</title>
    <style>
...
<body>
    ...
    <div class="doc-title">REKAP KUESIONER DOSEN</div>
        ...
        <tr>
            <td style="width: 50%; vertical-align: top;">
                <table class="summary-table">
                    <tr>
                        <td class="summary-label">Nama Dosen</td>
                        <td class="summary-colon">:</td>
                        <td class="summary-value">{{ $dosen_name ?: '-' }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="summary-colon">:</td>
                        <td class="summary-value">{{ $courseSummaries->count() }}</td>
                    </tr>
                </table>
            </td>
            <td style="width: 50%; vertical-align: top; padding-left: 16px;">
                <table class="summary-table">
                    <tr>
                        <td class="summary-label">Dicetak</td>
                        <td class="summary-colon">:</td>
                        <td class="summary-value">{{ now()->format('d/m/Y H:i') }}</td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <thead>
            <tr>
                ...
                @foreach ($scoreLabels as $score => $label)
                    <th style="width: 50px;" class="center">{{ $label }}</th>
                @endforeach
            </tr>
        </thead>
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="10" class="center">Belum ada data rekap kuesioner.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
