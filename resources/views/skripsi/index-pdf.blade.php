...
<body>
    ...
    <div class="doc-title">DAFTAR PENGAJUAN JUDUL SKRIPSI</div>
    <div class="doc-sub">
    ...
    <table class="tbl">
        ...
        @forelse ($items as $row)
            <tr>
                ...
                <td>
                    <div style="font-weight: 700;">{{ $row->judul ?: '-' }}</div>
                </td>
                <td class="center">
        ...
        @empty
            <tr>
                <td colspan="5" class="center" style="padding: 16px;">Belum ada data pengajuan skripsi.</td>
            </tr>
        @endforelse
        </tbody>
    </table>
