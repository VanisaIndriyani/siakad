...
class KegiatanController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'sekretaris_panitia_nama' => ['nullable', 'string', 'max:255'],
            'sekretaris_panitia_nip' => ['nullable', 'string', 'max:50'],
        ...
        $payload = [
            ...
            'sekretaris_panitia_nama' => $validated['sekretaris_panitia_nama'] ?? null,
            'sekretaris_panitia_nip' => $validated['sekretaris_panitia_nip'] ?? null,
